...
#metric_dir_older_edp = "/mnt/san03RAID1/tools/AIBench/EMON_event_files/"
metric_dir_older_edp = "/root/sbhatt3/edp-v4.1/"
#metric_dir_latest_edp = "/mnt/san03RAID1/tools/AIBench/EMON_event_files/edp-v4.01/Architecture Specific/"
metric_dir_latest_edp = "/root/sbhatt3/edp-v4.1/Architecture Specific/"
metrics_files_older_edp = {
    ...
    'clx': metric_dir_older_edp + 'Architecture Specific/CascadeLake/CLX-2S/clx-2s.xml',
    'amd': metric_dir_older_edp + 'Architecture Specific/Competitive/AMD/zen.xml',
}
metrics_files_latest_edp = {
    ...
    'clx': metric_dir_latest_edp + 'CascadeLake/CLX-2S/clx-2s.xml',
    'amd': metric_dir_latest_edp + 'AMD/Zen/zen.xml',
}
